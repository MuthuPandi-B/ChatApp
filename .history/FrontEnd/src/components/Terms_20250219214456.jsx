...
const Terms = () => {
  return (
    <div className="container mx-auto p-6 text-gray-800">
      ...
      <p className="mb-4">
        Welcome to ChatApp! These Terms and Conditions outline the rules and regulations for the use of our platform.
      </p>

      <h2 className="text-xl font-semibold mt-4">1. Acceptance of Terms</h2>
      <p className="mb-4">
        By using ChatApp, you agree to abide by these terms. If you do not agree, please do not use our services.
      </p>

      <h2 className="text-xl font-semibold mt-4">2. User Accounts</h2>
      <p className="mb-4">
        To access certain features, you may need to create an account. You are responsible for maintaining the security of your account and password.
      </p>
      ...
      <p className="mb-4">
        You agree not to engage in activities such as harassment, spamming, or sharing illegal content.
      </p>
