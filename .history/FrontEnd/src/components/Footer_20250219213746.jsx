  ...
  return (
    <footer className="bg-gray-800 text-white p-4 text-center flex justify-center items-center">
      {isLoggedIn ? (
        <p>
          Hello {userName}! &bull; 
          <Link to={"./register"} className="hover:underline ml-2 flex items-center">Terms & Conditions</Link>
          <Link to={"./contact"} className="hover:underline ml-2 flex items-center">Contact Us !</Link>
        </p>
      ) : (
        <p>
