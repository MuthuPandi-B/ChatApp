...
import linkedinLogo from '../assets/linkedin.png'; // Add your contact logos similarly

const contacts = [
  { name: 'GitHub', logo: githubLogo, link: 'https://github.com/MuthuPandi-B' },
  { name: 'LinkedIn', logo: linkedinLogo, link: 'https://www.linkedin.com/in/muthu-pandi-b8a1b321a/' },
];
        ...
        <div className="flex gap-4 mb-8">
          {contacts.map((contact, index) => (
            <a key={index} href={contact.link} target="_blank" rel="noopener noreferrer">
              <img src={contact.logo} alt={contact.name} className="w-8 h-8 rounded-lg hover:w-10 hover:h-10" />
            </a>
          ))}
        </div>
      </div>
